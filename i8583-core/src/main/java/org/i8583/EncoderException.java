...
/**
 * Thrown by the encoder when is there is a failure in the encoding process.
 * <p/>
 * Such a failure could be because of invalid data or value out of range.
 * 
 * @author ennovatenow
 * @see org.apache.commons.codec.EncoderException
 */
public class EncoderException extends RuntimeException {

    private static final long serialVersionUID = 1870134235485427035L;
