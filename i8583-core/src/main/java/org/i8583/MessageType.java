...
public interface MessageType {
    ...
    /**
     * Returns the Bitmap index definition of the Message.
     * 
     * @return The Bitmap index definition of the Message.
     */
    Element getBitmap();

    /**
     * Returns the metadata of the data element in the Message
     * 
     * @param position
     *            Position of the element in the message.
     * @return The metadata of the data element identified by the position.
     */
